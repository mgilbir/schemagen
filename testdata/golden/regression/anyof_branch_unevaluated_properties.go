...
type AnyOfBranchUnevaluatedProperties struct {
...
func (a *AnyOfBranchUnevaluatedProperties) UnmarshalJSON(data []byte) error {
	a.AdditionalProperties = nil
	a._jsonRawProps = nil
	if string(data) == "null" {
		return fmt.Errorf("null is not allowed for type AnyOfBranchUnevaluatedProperties")
	}
	...
	type Alias AnyOfBranchUnevaluatedProperties
	aux := &struct {
		*Alias
...
func (a AnyOfBranchUnevaluatedProperties) MarshalJSON() ([]byte, error) {
	type Alias AnyOfBranchUnevaluatedProperties
	aux := struct {
		Alias
	}{
...
// Validate checks AnyOfBranchUnevaluatedProperties against its JSON Schema constraints.
func (a AnyOfBranchUnevaluatedProperties) Validate() error {
