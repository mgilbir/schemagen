...
// AnnBigInt holds an integer value with arbitrary-precision support (int64 + *big.Int).
//
// Read-only: the schema says "readOnly", so the owning authority manages
// this value and an application is not expected to send it.
// Write-only: the schema says "writeOnly", so the value is not expected
...
func (a AnnBigInt) MarshalJSON() ([]byte, error) {
	if a._isBigInt && a._bigInt != nil {
		return []byte(a._bigInt.String()), nil
	}
	return json.Marshal(a._int64)
}
func (a AnnBigInt) Int64() int64 { return a._int64 }
func (a AnnBigInt) BigInt() *big.Int {
	if a._isBigInt && a._bigInt != nil {
		return a._bigInt
	}
	return big.NewInt(a._int64)
}
func (a AnnBigInt) IsBigInt() bool { return a._isBigInt }
func (a AnnBigInt) String() string { return a.BigInt().String() }
...
func (a AnnBigInt) Validate() error {
	{
		...
		if _val.Cmp(_limit) < 0 {
			return fmt.Errorf("value: %s is less than minimum 0", a.BigInt().String())
		}
	}
	return nil
}
...
// DepBigInt holds an integer value with arbitrary-precision support (int64 + *big.Int).
//
// Deprecated: the schema marks this deprecated.
...
func (d DepBigInt) MarshalJSON() ([]byte, error) {
	if d._isBigInt && d._bigInt != nil {
		return []byte(d._bigInt.String()), nil
	}
	return json.Marshal(d._int64)
}
func (d DepBigInt) Int64() int64 { return d._int64 }
func (d DepBigInt) BigInt() *big.Int {
	if d._isBigInt && d._bigInt != nil {
		return d._bigInt
	}
	return big.NewInt(d._int64)
}
func (d DepBigInt) IsBigInt() bool { return d._isBigInt }
func (d DepBigInt) String() string { return d.BigInt().String() }
...
func (d DepBigInt) Validate() error {
	{
		...
		_limit.SetString("0")
		if _val.Cmp(_limit) < 0 {
			return fmt.Errorf("value: %s is less than minimum 0", d.BigInt().String())
		}
	}
	return nil
}
...
func (p PlainBigInt) MarshalJSON() ([]byte, error) {
	if p._isBigInt && p._bigInt != nil {
		return []byte(p._bigInt.String()), nil
	}
	return json.Marshal(p._int64)
}
func (p PlainBigInt) Int64() int64 { return p._int64 }
func (p PlainBigInt) BigInt() *big.Int {
	if p._isBigInt && p._bigInt != nil {
		return p._bigInt
	}
	return big.NewInt(p._int64)
}
func (p PlainBigInt) IsBigInt() bool { return p._isBigInt }
func (p PlainBigInt) String() string { return p.BigInt().String() }
...
func (p PlainBigInt) Validate() error {
	{
		...
		_limit.SetString("0")
		if _val.Cmp(_limit) < 0 {
			return fmt.Errorf("value: %s is less than minimum 0", p.BigInt().String())
		}
	}
	return nil
}
