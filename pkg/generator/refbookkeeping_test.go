...
func TestNeverResolvedRefsIgnoresRefsResolvedElsewhere(t *testing.T) {
	g := New(Config{})
	g.unresolvedRefs["app://a.json#/definitions/only-failed"] = map[string]bool{refKeyword: true}
	g.unresolvedRefs["app://a.json#/definitions/also-succeeded"] = map[string]bool{refKeyword: true}
...
func TestGenerateResetsRefBookkeeping(t *testing.T) {
	...
	g.unresolvedRefs["app://stale.json#/definitions/x"] = map[string]bool{refKeyword: true}
	...
	if g.unresolvedRefs["app://stale.json#/definitions/x"] != nil {
