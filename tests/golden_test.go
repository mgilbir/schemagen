...
func allGoldenTests() []goldenTestCase {
	return []goldenTestCase{
		...
		{"regression/allof_property_conjunction", "testdata/schemas/regression/allof_property_conjunction.json", "testdata/golden/regression/allof_property_conjunction.go"},
		{"regression/allof_sibling_values", "testdata/schemas/regression/allof_sibling_values.json", "testdata/golden/regression/allof_sibling_values.go"},
		// The draft-07 half of #238's gating. The instance verdicts are the same
		// whether or not the arm stands down here -- generateTypeDef's own ref
		// arms answer either way -- and what the arm firing costs is a type: the
